        ...
        <div class="container">
            ...
            <div class="row" id="main-content">
                ...
                <div class="span4" id="sidebar">
                    ...
                    <div class="thumbnail" style="margin-bottom:10px; padding:10px;">
                    ...
                    <ul  id="sidenav01" class="accordion nav nav-department  nav-tabs nav-stacked ulstyle">
                        <li  class="accordion-group">
                            <a href="#" data-toggle='collapse' data-target='#subnav00' data-parent='#sidenav01' class="accordion-toggle collapsed">
                                <i class="icon-chevron-right pull-right"></i>Page 2 
                            </a>
                            <ul id="subnav00" class="nav nav-list collapse accordian-child" >
