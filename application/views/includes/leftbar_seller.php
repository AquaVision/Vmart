  ...
  <ul id="sidenav01" class="accordion nav nav-department nav-tabs nav-stacked ulstyle">
    ...
    <div class="thumbnail">
        ...
        <script>(function(d, s, id) {
            ...
            js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=1375978969291974";
            fjs.parentNode.insertBefore(js, fjs);
        }(document, 'script', 'facebook-jssdk'));</script>
        <div class="fb-like-box" data-href="https://www.facebook.com/aquavisiononline" data-width="260" data-show-faces="true" data-stream="false" data-show-border="true" data-header="true"></div>
        -->
