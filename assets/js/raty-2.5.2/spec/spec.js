        ...
        context('changes to false', function() {
            ...
            context('with :cancel', function() {
                it ('shows the button', function() {
                    ...
                    expect(self.children('.raty-cancel')).not.toHaveCss({
                        display: 'block'
                    });
                });
