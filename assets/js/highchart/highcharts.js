...
(function(){
    function v(a,b){
        ...
        var a,b=arguments.length,c={},d=function(a,b){
            var c,h;
            for(h in b)b.hasOwnProperty(h)&&(c=b[h],typeof a!=="object"&&(a={}),a[h]=c&&typeof c==="object"&&Object.prototype.toString.call(c)!=="[object Array]"&&typeof c.nodeType!=="number"?d(a[h]||{},c):b[h]);return a
            };
    ...
    else if(r(b)&&V(b))for(d in b)a.setAttribute(d,b[d]);return e
    }
    function ha(a){
    return Da(a)?
    a:[a]
...
function wa(a,b){
    ...
    for(g=0;g<c.length;g++)if(d=c[g],e=E[d[0]],f=d[1],c[g+1]&&a<=(e*f[f.length-1]+E[c[g+1][0]])/2)break;e===E[xa]&&a<5*e&&(f=[1,2,5]);
...
!!z.createElement("canvas").getContext,Sa,fb=z.documentElement.ontouchstart!==y,Nb={},ub=0,$a,N,Ua,za,vb,E,ta=function(){},Ba=[],ya="div",S="none",Ob="rgba(192,192,192,"+(Z?1.0E-4:0.002)+")",Bb="millisecond",jb="second",Va="minute",Oa="hour",oa="day",Wa="week",Pa="month",xa="year",Pb="stroke-width",Za,kb,lb,nb,Qa,Xa,Ya,Db,Eb,mb,Fb,Gb,aa={};
...
css:function(a){
    ...
    if(Fa&&!Z)c&&delete a.width,L(this.element,a);
        ...
        for(d in a)e+=d.replace(/([A-Z])/g,f)+":"+a[d]+";";A(b,"style",e)
        }
...
color:function(a,b,c){
    ...
    if(g){
        ...
        for(l in c)l!=="id"&&p.push(l,c[l]);for(l in j)p.push(j[l]);p=p.join(",");
...
label:function(a,b,c,d,e,f,g,h,i){
    ...
    var p=this,s=p.g(i),o=p.text("",0,0,g).attr({
    zIndex:1
}),B,w,G=0,q=3,hb=0,Ma,yb,P,H,C=0,u={},A,g=s.attrSetters,z;
J(s,"add",l);
g.width=function(a){
    Ma=a;
    return!1
    ...
    attr:function(a,b){
        ...
        if(fa(a))c=a,s=c==="strokeWidth"||
            ...
            if(j&&/^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c))k||(this.symbolAttr(a),k=!0),l=!0;
                ...
                e=d.length;
                l=[];
                for(var o;e--;)if(Ea(d[e]))l[e]=t(d[e]*10)-5;
                    else if(d[e]==="Z")l[e]="x";
...
color:function(a,b,c,d){
    ...
    if(i){
        ...
        if(c==="fill")if(i==="gradient")c=l.x1||l[0]||0,a=l.y1||l[1]||0,p=l.x2||l[2]||0,l=l.y2||l[3]||0,q='angle="'+(90-I.atan((l-a)/(p-c))*180/Ka)+'"',y();
            else{
...
pb.prototype={
    render:function(){
        ...
        if(p)s?p.animate({
            ...
            },G)e(n);if(f&&r(f.text)&&s&&s.length&&b.width>0&&b.height>0){
            f=x({
                align:c&&k&&"center",
                x:c?!k&&4:10,
...
init:function(a,b){
    ...
    for(f in d)J(this,f,d[f]);if(this.isLog)this.val2lin=ka,this.lin2val=da
        },
...
defaultLabelFormatter:function(){
    ...
    else if(f&&a>=1E3)for(;f--&&g===y;)c=Math.pow(1E3,f+1),a>=c&&e[f]!==null&&(g=ua(b/c,-1)+e[f]);
...
getOffset:function(){
    ...
    if(b||a.isLinked)n(e,function(b){
        ...
        [h]===s.align)t=q(f[a].getLabelSize(),t)
            }),a.staggerLines&&(t+=(a.staggerLines-1)*16);else for(v in f)f[v].destroy(),delete f[v];if(p&&p.text&&
        p.enabled!==!1){
...
rb.prototype={
    ...
    runPointActions:function(a){
        ...
        if(d&&this.options.tooltip.shared&&
            ...
            e=[];
            h=c.length;
            for(i=0;i<h;i++)if(c[i].visible&&c[i].options.enableMouseTracking!==!1&&!c[i].noSharedTooltip&&c[i].tooltipPoints.length&&(b=c[i].tooltipPoints[k],b.series))b._dist=Q(k-b.clientX),j=K(j,b._dist),e.push(b);for(h=e.length;h--;)e[h]._dist>j&&e.splice(h,1);
...
sb.prototype={
    ...
    colorizeItem:function(a,b){
        ...
        if(f){
            if(g)for(j in g=a.convertAttribs(g),g)d=g[j],d!==y&&(i[j]=d);f.attr(i)
            }
        },
...
redraw:function(a){
    ...
    if(g)for(j=i;j--;)if(a=c[j],a.options.stacking)a.isDirty=
        !0;n(c,function(a){
...
R.prototype={
    ...
    processData:function(a){
        ...
        if(m&&this.sorted&&(!k||d>k||this.forceCrop))if(a=i.getExtremes(),i=a.min,k=a.max,b[d-1]<i||b[0]>k)b=[],c=[];
            ...
            for(a=b.length-1;a>0;a--)if(d=b[a]-b[a-1],d>0&&(h===y||d<h))h=d;this.cropped=g;
        this.cropStart=e;
    ...
    generatePoints:function(){
        ...
        if(b&&(g!==
            (c=b.length)||j))for(l=0;l<c;l++)if(l===h&&!j&&(l+=g),b[l])b[l].destroyElements(),b[l].plotX=y;this.data=b;
        this.points=m
        },
    translate:function(){
...
getAttribs:function(){
    ...
    for(g=i.length;g--;){
        ...
        if(h.options)for(p in m)r(c[m[p]])&&(f=!0);if(f){
            c=c||{};
...
update:function(a,b){
    var c=this.chart,d=
    this.type,a=x(this.userOptions,{
        animation:!1,
        index:this.index,
